...
function Custom() {
  const carouselItems = [
    { img: "custom1.jpeg", alt: "Custom Tour Packages", placeholder: "Search Places", title: "Explore with Custom Tour Package" },
    { img: "coustom.jpg", alt: "Custom Tour 1", placeholder: "Search Places", title: "Explore with Custom Tour Package" },
    { img: "custom2.jpeg", alt: "Custom Tour 2", placeholder: "Search Places", title: "Explore with Custom Tour Package" },
    { img: "custom3.webp", alt: "Custom Tour 3", placeholder: "Search Places", title: "Explore with Custom Tour Package" },
    { img: "custom4.webp", alt: "Custom Tour 4", placeholder: "Search Places", title: "Explore with Custom Tour Package" },
    { img: "custom5.webp", alt: "Custom Tour 5", placeholder: "Search Places", title: "Explore with Custom Tour Package" },
  ];
  ...
  },
  {
    ...
    "addOns": ["Forest Yoga", "Organic Food Tasting", "Night Walk"]
  },
  {
    "id": 3,
    "title": "Kuala Lumpur City & Culture Tour",
    "duration": "4N5D",
          ...
          <div className="col-md-4 mb-4" key={pkg.id}>
            <div className="card h-100 shadow">
              <div className="card-body">
                ...
                <p><strong>Add-ons:</strong> {pkg.addOns.join(', ')}</p>
              </div>
              
              <div className="card-footer text-center bg-primary text-Dark w-30">
                <button className="btn btn-primary m-auto w-40">Book Now</button>
              </div>
            </div>
          </div>
        ))}
